...
export default function ExperienceComponent(){
    return(
        <>
         <div id="EXPERIENCE" className="relative flex flex-col justify-center items-center gap-4 my-20 md:my-30 ">
            <DottedGlowBackground className="  absolute inset-0 w-full h-full -z-10 "  glowColor="gray"/>

            <div className="relative z-10 mb-10 flex flex-col justify-center items-center ">
